...
RotateController::RotateController():
    Controller( kControllerRotate )
{

}

RotateController::RotateController(const float &rotationRateRadPerSec):
    Controller      ( kControllerRotate ),
    rotationRate_   ( rotationRateRadPerSec )
{
...
RotateController::RotateController( const RotateController &other ):
    Controller      ( kControllerRotate ),
