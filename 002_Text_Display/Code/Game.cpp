...
Game::Game() :
    ...
    // Text Widget initialization. Ideally you would want to define the string in the 
    // string table and retrieve it using its StringID, similar to the 
    // spectatorLocatorRegistrar constructor above. For simplicity we will just hardcode
    // it here.
